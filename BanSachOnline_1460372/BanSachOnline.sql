...
insert into Series(Ten_Series, TrangBia_Series, Gia_Series, NoiDung_Series) values ('Real Account', '/Content/Image/Book/Cover/c001.png', 463, 'In a world driven by fictionalized friendship, courtesy of the program named "real account", the table suddenly turns, and the cybernetic world turns real! how will they survive?')

insert into Series(Ten_Series, TrangBia_Series, Gia_Series, NoiDung_Series) values ('Helck', '/Content/Image/Book/Cover/c002.png', 596, 'After the last Demon King was defeated, a Demon Kingdom is running a contest to choose the next King. A muscular and high-level human named Helck joined and said that he wants to destroy all human. Is he serious?

Elf "Vamirio", one of the four Great Kings of the whole Demon Empire, cannot believe in this. She is monitoring the contest. The story starts in the Demon Kingdom. What''s the secret behind Helck and the human world?')

insert into Series(Ten_Series, TrangBia_Series, Gia_Series, NoiDung_Series) values ('Doraemon', '/Content/Image/Book/Cover/c003.png', 463, 'Doraemon, a cat shaped robot which came from the 22nd century in the future, goes back in time in order to help Nobita, a below average lazy kid, to make his life less miserable and improve his descendent''s life. With many of Doreamon''s gadgets from the future, Nobita''s life will never be the same.

Doraemon was awarded the first Shogakukan Manga Award for children''s manga in 1982, and the first Osamu Tezuka Culture Award in 1997.')

insert into Series(Ten_Series, TrangBia_Series, Gia_Series, NoiDung_Series) values ('Conan', '/Content/Image/Book/Cover/c004.png', 463, '16 year-old Kudo Shinichi, a famous High school detective, treats his friend, Mori Ran to a theme park named Tropical Land. After solving a murder case that occured on the same day, Shinichi notices and tails two people in black. However, one of them notices Shinichi and knocks him out. Instead of killing him, they gave him an untested poison that was supposed to kill him yet leave no traces. However, instead of killing him, it shrunk him into a 8 year old boy. Shinichi now goes under the name Edogawa Conan.')

insert into Series(Ten_Series, TrangBia_Series, Gia_Series, NoiDung_Series) values ('Black Jack', '/Content/Image/Book/Cover/c005.png', 453, 'Black Jack is the doctor Tezuka wished he could be, one free of the constraints of the modern rules, who can heal and help on his rules. He travels the world helping those who pay him, sometime those he takes mercy on, and always those who move him. Despite not having a valid license, he is still the doctor of last resort, the only man who keeps the reaper at bay. Sometimes though, he''s the one who brings the reaper...

Won the 1st Kodansha Manga Award for shounen.')
insert into Series(Ten_Series, TrangBia_Series, Gia_Series, NoiDung_Series) values ('Gift Å}', '/Content/Image/Book/Cover/c006.png', 637, 'My Manga love, It is about the girl who her name is Tamaki, save and respect human live')
...
insert into GiaoHang_Sach(ID_Sach, ID_GiaoHang) values (23, 4)
insert into GiaoHang_Sach(ID_Sach, ID_GiaoHang) values (24, 4)
insert into GiaoHang_Sach(ID_Sach, ID_GiaoHang) values (25, 4)
insert into GiaoHang_Sach(ID_Sach, ID_GiaoHang) values (26, 4)
insert into GiaoHang_Sach(ID_Sach, ID_GiaoHang) values (27, 4)
insert into GiaoHang_Sach(ID_Sach, ID_GiaoHang) values (28, 4)
insert into GiaoHang_Sach(ID_Sach, ID_GiaoHang) values (29, 4)
insert into GiaoHang_Sach(ID_Sach, ID_GiaoHang) values (30, 4)
insert into GiaoHang_Sach(ID_Sach, ID_GiaoHang) values (31, 4)
insert into GiaoHang_Sach(ID_Sach, ID_GiaoHang) values (32, 4)
insert into GiaoHang_Sach(ID_Sach, ID_GiaoHang) values (33, 4)
insert into GiaoHang_Sach(ID_Sach, ID_GiaoHang) values (34, 4)
insert into GiaoHang_Sach(ID_Sach, ID_GiaoHang) values (35, 4)
insert into GiaoHang_Sach(ID_Sach, ID_GiaoHang) values (36, 4)
insert into GiaoHang_Sach(ID_Sach, ID_GiaoHang) values (37, 4)
insert into GiaoHang_Sach(ID_Sach, ID_GiaoHang) values (38, 4)
insert into GiaoHang_Sach(ID_Sach, ID_GiaoHang) values (39, 4)
insert into GiaoHang_Sach(ID_Sach, ID_GiaoHang) values (40, 4)
...
add constraint FK_SachBinhLuan foreign key (ID_Sach) references Sach(ID_Sach),
	constraint FK_SachKhacHang foreign key (ID_KH) references AspNetUsers(ID);

alter table GiaoHang_Sach
add constraint FK_SachGiaoHang_Sach foreign key (ID_Sach) references Sach(ID_Sach);

alter table DatHang
add constraint FK_KhachHangDatHang foreign key (ID_KH) references KhachHang(ID_KH);
...
--add constraint FK_TaiKhoanKhachHang foreign key (ID_TaiKhoan) references TaiKhoan(ID_TaiKhoan);
