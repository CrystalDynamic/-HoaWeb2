...
(
	...
	primary key (ID_BinhLuan, ID_Sach, ID_TaiKhoan)
)
...
(
	...
	ID_TinhTrang int,
	primary key (ID_DatHang, ID_TaiKhoan)
)
...
(	
	--ID_DatHangChiTiet int identity (1, 1),
	ID_DatHang int,
	ID_TaiKhoan varchar(10),
	ID_Sach int,
	...
	primary key (ID_DatHang, ID_TaiKhoan, ID_Sach)
)
...
--	constraint FK_TaiKhoanBinhLuan foreign key (ID_TaiKhoan) references TaiKhoan(ID_TaiKhoan)

--alter table DatHang
--add constraint FK_TaiKhoanDatHang foreign key (ID_TaiKhoan) references TaiKhoan(ID_TaiKhoan),
--	constraint FK_TinhTrangDatHang foreign key (ID_TinhTrang) references TinhTrang(ID_TinhTrang)

--alter table DatHangChiTiet
--add constraint FK_DatHangDatHangChiTiet foreign key (ID_DatHang, ID_TaiKhoan) references DatHang(ID_DatHang, ID_TaiKhoan),
